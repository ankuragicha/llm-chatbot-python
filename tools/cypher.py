...
Fine Tuning:
If the word "directed" is mentioned in user user query use relationship type as "DIRECTED", if word "actor" or "acted" is mentioned use relationship type as "ACTED_IN.
